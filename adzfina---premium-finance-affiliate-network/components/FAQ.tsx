    ...
    <section id="faq" className="py-24 bg-zinc-50">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            {faqs.map((faq, idx) => (
                <div key={idx} className="bg-white rounded-2xl border border-zinc-200 overflow-hidden">
                    ...
                    >
                        ...
                        {openIndex === idx ? <Minus size={20} className="text-zinc-400" /> : <Plus size={20} className="text-zinc-400" />}
                    </button>
                    {openIndex === idx && (
                        <div className="px-6 pb-6 text-zinc-600 leading-relaxed animate-fade-in">
                            {faq.a}
                        </div>
                    )}
                </div>
        ...
        <div className="mt-12 text-center">
            ...
            <a href="mailto:support@adzfina.com" className="inline-block bg-white border border-zinc-200 text-zinc-900 px-6 py-3 rounded-full font-bold hover:bg-zinc-50 transition-colors">
                Contact Support
            </a>
