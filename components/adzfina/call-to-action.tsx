      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-zinc-900 rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-zinc-400 mb-10 max-w-2xl mx-auto text-pretty">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-lime-400 text-zinc-900 px-8 py-4 rounded-full font-bold hover:bg-lime-300 transition-colors shadow-lg shadow-lime-900/20"
              >
                Get Started
              </button>
              <button
                onClick={() => scrollToSection("features")}
                className="bg-transparent border border-zinc-700 text-white px-8 py-4 rounded-full font-bold hover:bg-zinc-800 transition-colors"
              >
                Learn More
              </button>
            </div>
